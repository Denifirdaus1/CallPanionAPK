-- Drop and recreate the function with TABLE return type
DROP FUNCTION IF EXISTS public.add_relative_secure(uuid,text,text,text,text,text,text,text,text,text,text,boolean);
