-- Step 2: Patch unsafe JSON parsing in database functions
...
-- Step 3: Ensure relatives table has proper RLS policies
...
-- Create proper RLS policies for relatives
...
-- Ensure created_by has a default value to pass RLS consistently
