...
-- Simplified RLS Policies for call_permissions (elder can read own, admins can read all)
...
-- Simplified RLS Policies for call_audit (elder can read own, admins can read all)
...
-- Insert policy for call_audit (elders can insert their own, admins can insert any)
