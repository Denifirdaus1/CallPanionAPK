-- Fix storage bucket policies to make media private by default
-- Update storage bucket policies for family-photos
...
-- Update storage bucket policies for family-media
...
-- Add RLS policy for devices table to match access patterns
